...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Kayıt Ol"),centerTitle: true, backgroundColor:Color.fromARGB(255, 245, 245, 220) ,),
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text("Kayıt Ol",style: TextStyle(fontSize: 16,color: Colors.black),),
              ),
            ],
          ),
        ),
